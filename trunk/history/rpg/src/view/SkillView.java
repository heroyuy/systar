...
public class SkillView extends BaseView {
    ...
    public void paint(Graphics g) {
        ...
        g.drawString("技 能", gd.screenWidth / 2, (th - g.getFont().getHeight()) / 2, Const.Anchor.HT);
        /**
         * 列表
         */
        //底框
        ...
        Painter.drawTable(g, (gd.screenWidth - cellW) / 2-gap/2, th, cellW, cellH, gd.skill_showNum, space, skills, Const.Color.BLACK, gd.skill_topIndex, gd.skill_curIndex, Const.Anchor.HV, Painter.NODIALOG, Painter.CELL_DEEP);
        ...
        if (gd.player.bag.get(Bag.SKILL, gd.skill_curIndex) != null) {
            Painter.drawWordWrapString(g, gd.player.bag.get(Bag.SKILL, gd.skill_curIndex).intro, gap / 2, th + ch + gap / 2, gd.screenWidth - gap, ih - gap, Const.Color.WHITE);
