...
public class AboutDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        aboutArea.setText("版本："+SoftInformation.majorVersion+"."+
            SoftInformation.minorVersion+"."+SoftInformation.lastVersion+"."+
        ...
        aboutLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/soyomaker/resources/logo.png"))); // NOI18N
