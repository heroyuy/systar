...
public class DataManager {
    ...
    public static ImageIcon[] listStatusIconName() {
        File f = new File(AppData.getInstance().getCurProject().getPath() + File.separator + "image" + File.separator + "icon" + File.separator + "status");
        if (!f.exists()) {
            f.mkdirs();
        }
...
//        String[] s = f.list();
    ...
    public static ImageIcon[] listEquipIconName() {
        File f = new File(AppData.getInstance().getCurProject().getPath() + File.separator + "image" + File.separator + "icon" + File.separator + "equip");
        if (!f.exists()) {
            f.mkdirs();
        }
        ArrayList<File> files = new ArrayList<File>();
...
//        String[] s = f.list();
    ...
    public static ImageIcon[] listSkillIconName() {
        File f = new File(AppData.getInstance().getCurProject().getPath() + File.separator + "image" + File.separator + "icon" + File.separator + "skill");
        if (!f.exists()) {
            f.mkdirs();
        }
        ArrayList<File> files = new ArrayList<File>();
...
//        String[] s = f.list();
    ...
    public static ImageIcon[] listItemIconName() {
        File f = new File(AppData.getInstance().getCurProject().getPath() + File.separator + "image" + File.separator + "icon" + File.separator + "item");
        if (!f.exists()) {
            f.mkdirs();
        }
        ArrayList<File> files = new ArrayList<File>();
...
//        String[] s = f.list();
    ...
    public static String[] listWalkImageName() {
        File f = new File(AppData.getInstance().getCurProject().getPath() + File.separator + "image" + File.separator + "character");
        if (!f.exists()) {
            f.mkdirs();
        }
        ArrayList<File> files = new ArrayList<File>();
    ...
    public static String[] listSkinImageName() {
        File f = new File(AppData.getInstance().getCurProject().getPath() + File.separator + "image" + File.separator + "skin");
        if (!f.exists()) {
            f.mkdirs();
        }
        ArrayList<File> files = new ArrayList<File>();
    ...
    public static String[] listPictureImageName() {
        File f = new File(AppData.getInstance().getCurProject().getPath() + File.separator + "image" + File.separator + "picture");
        if (!f.exists()) {
            f.mkdirs();
        }
    ...
    public static String[] listTitleBackgroundName() {
        File f = new File(AppData.getInstance().getCurProject().getPath() + File.separator + "image" + File.separator + "title");
        if (!f.exists()) {
            f.mkdirs();
        }
    ...
    public static String[] listSoundName() {
        File f = new File(AppData.getInstance().getCurProject().getPath() + File.separator + "audio" + File.separator + "sound");
        if (!f.exists()) {
            f.mkdirs();
        }
        ArrayList<File> files = new ArrayList<File>();
    ...
    public static String[] listMusicName() {
        File f = new File(AppData.getInstance().getCurProject().getPath() + File.separator + "audio" + File.separator + "music");
        if (!f.exists()) {
            f.mkdirs();
        }
        ArrayList<File> files = new ArrayList<File>();
