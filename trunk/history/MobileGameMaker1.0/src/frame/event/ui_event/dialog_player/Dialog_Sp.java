...
public class Dialog_Sp extends Event_Dialog {
    ...
    public Dialog_Sp(Dialog_Main parent) {
        super(parent);
        initialize();
        p = parent;
    }
    ...
    public boolean confirm() {
        ...
        if (Optype == 0) {
            if (type == 0) {
                sc = "$SP" + "+=" + getJTextField_const().getText();
            } else {
                sc = "$SP" + "-=" + getJTextField_const().getText();
            }
        } else {
            if (type == 0) {
                sc = "$SP" + "+=$VAR[" + getJComboBox_var().getSelectedIndex() + "]";
            } else {
                sc = "$SP" + "-=$VAR[" + getJComboBox_var().getSelectedIndex() + "]";
            }
        }
