...
public class Dialog_Money extends Event_Dialog {
    ...
    public Dialog_Money(Dialog_Main parent) {
        super(parent);
        initialize();
        p = parent;
    }
    ...
    public boolean confirm() {
        ...
        if (Optype == 0) {
            if (type == 0) {
                sc = "$MONEY" + "+=" + getJTextField_const().getText();
            } else {
                sc = "$MONEY" + "-=" + getJTextField_const().getText();
            }
        } else {
            if (type == 0) {
                sc = "$MONEY" + "+=$VAR[" + getJComboBox_var().getSelectedIndex() + "]";
            } else {
                sc = "$MONEY" + "-=$VAR[" + getJComboBox_var().getSelectedIndex() + "]";
            }
        }
