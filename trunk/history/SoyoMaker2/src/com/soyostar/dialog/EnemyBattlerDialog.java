 ...
 */
public class EnemyBattlerDialog extends javax.swing.JDialog {

    /** Creates new form EnemyBattlerDialog
     * @param parent 
     * @param modal 
     */
    public EnemyBattlerDialog(DataEditorDialog parent, boolean modal) {
        super(parent, modal);
        ded = parent;
        init();
        initComponents();
    ...
    private void init() {
        ...
        if (file != null) {
            ...
            try {
                ...
                Log.getLogger(EnemyBattlerDialog.class).error("battler img load error", ex);
            }
        }
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        ...
        if (imgList.getSelectedIndex() != -1) {
            ...
            ((Enemy) SoftProxy.getInstance().getCurProject().getDataManager().getModels(Model.ENEMY)[ded.getCurSelectEnemyIndex()]).headImg = imgList.getSelectedValue().toString();
            ded.enemyBattImgPanel.repaint();
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                EnemyBattlerDialog dialog = new EnemyBattlerDialog(null, true);
