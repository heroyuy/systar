...
/*
 * playerMoveImageDialog.java
 *
 * Created on 2011-5-8, 14:13:46
 */
 ...
 */
public class PlayerMoveImageDialog extends javax.swing.JDialog {

    /** Creates new form playerMoveImageDialog
     * @param parent 
     * @param modal 
     */
    public PlayerMoveImageDialog(DataEditorDialog parent, boolean modal) {
        super(parent, modal);
        ded = parent;
        init();
        initComponents();
    ...
    private void init() {
        ...
        File file = new File(SoftProxy.getInstance().getCurProject().getPath() + File.separatorChar + "image" + File.separatorChar + "character");
        ...
        if (file != null) {
            ...
            try {
                ...
                Log.getLogger(PlayerMoveImageDialog.class).error("character img load error", ex);
            }
        }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(PlayerMoveImageDialog.class);
...
//            System.out.println(imgList.getSelectedValue().toString());
            ((Player) SoftProxy.getInstance().getCurProject().getDataManager().getModels(Model.PLAYER)[0]).charImg = imgList.getSelectedValue().toString();
            ded.playerMoveImgPanel.repaint();
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                PlayerMoveImageDialog dialog = new PlayerMoveImageDialog(null, true);
