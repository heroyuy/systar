 ...
 */
public class SpDialog extends javax.swing.JDialog {

    /** Creates new form SpDialog
     * @param parent 
     * @param modal 
     */
    public SpDialog(ScriptDialog parent, boolean modal) {
        super(parent, modal);
        sd = parent;
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(SpDialog.class);
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(constTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 155, Short.MAX_VALUE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(varRadioButton)
                        .addGap(18, 18, 18)
                        .addComponent(varComboBox, 0, 155, Short.MAX_VALUE)))
                .addContainerGap())
        );
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        ...
        if (addRadioButton.isSelected()) {
            if (constRadioButton.isSelected()) {
                sd.insertScriptData(sd.npcPane.eventTable.getSelectedRow(), "setSp(" + "getSp()+" + constTextField.getText() + ");");
            } else {
                sd.insertScriptData(sd.npcPane.eventTable.getSelectedRow(), "setSp(" + "getSp()+" + "getVar(" + varComboBox.getSelectedIndex() + ")" + ");");
            }
        } else {
            if (constRadioButton.isSelected()) {
                sd.insertScriptData(sd.npcPane.eventTable.getSelectedRow(), "setSp(" + "getSp()-" + constTextField.getText() + ");");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                SpDialog dialog = new SpDialog(null, true);
