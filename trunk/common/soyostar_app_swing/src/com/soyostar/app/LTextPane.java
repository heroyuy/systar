 ...
 */
public class LTextPane extends Widget {
    ...
    public static void main(String[] args) {
        String text = "d<c>[0xffaabbcc]asadsads<c>[0xaabbccdd]asd";
    ...
    private void analyse(String text) {
        ...
        while (matcher.find()) {
            ...
            System.out.println("functionText:" + functionText);
