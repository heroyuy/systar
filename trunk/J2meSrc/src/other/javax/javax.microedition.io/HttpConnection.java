...
public interface HttpConnection extends ContentConnection
{
	 ...
	 * 
	 * @return the host information of the URL of this HttpConnection.
	 */
	 ...
	 * <code>HttpConnection</code>.
	 * 
	 * @return the network port number of the URL for this HttpConnection. The default HTTP port number (80) is returned if there was no port number in the string passed to Connector.open.
	 */
	public int getPort();
	 ...
	 * @return the value of the named general request property for this connection. If there is no key with the specified name then null is returned.
	 ...
	 * 
	 * @return the expiration date of the resource that this URL references, or 0 if not known. The value is the number of milliseconds since January 1, 1970 GMT.
	 * @throws IOException - if an error occurred connecting to the server.
	 */
	 ...
	 * 
	 * @return the sending date of the resource that the URL references, or 0 if not known. The value returned is the number of milliseconds since January 1, 1970 GMT.
	 * @throws IOException - if an error occurred connecting to the server.
	 */
	 ...
	 * @return the value of the named field, parsed as an integer. The def value is returned if the field is missing or malformed.
	 * @throws IOException - if an error occurred connecting to the server.
	 */
	 ...
	 * @return the value of the field, parsed as a date. The value of the def argument is returned if the field is missing or malformed.
	 * @throws IOException - if an error occurred connecting to the server.
	 */
	 ...
	 * @return the value of the  nth  header field or null if the array index is out of range. An empty String is returned if the field does not have a value.
	 * @throws IOException - if an error occurred connecting to the server.
	 */
