...
public abstract class Canvas extends Displayable
{
	...
	public int getKeyCode(int gameAction)
	{
		switch (gameAction) {
			...
			case LEFT: return -102;
			case RIGHT: return -103;
			case FIRE: return -104;
			default: return 0;
		}
	}
	...
	public int getGameAction(int keyCode)
	{
		switch (keyCode) {
			case -100: return UP;
			case -101: return DOWN;
			case -102: return LEFT;
			case -103: return RIGHT;
			case -104: return FIRE;
			default: return 0;
		}
	}
	...
	{
		// subclasses can use this behaviour
	}
	...
	/**
	 * Wrapper call for making the paint()-method publicly available.
	 * 
	 ...
	 * @param keyEvent
	 */
	public void _callKeyPressed(int keyEvent) {
		//System.out.println("Canvas: calling keyPressed( " + keyEvent + " ) in class [" + getClass().getName() + "]");
		keyPressed( keyEvent );
	}
	 ...
	 * @param y
	 */
	public void _callPointerPressed(int x, int y) {
