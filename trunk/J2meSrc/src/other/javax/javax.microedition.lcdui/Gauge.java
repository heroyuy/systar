...
public class Gauge extends Item
{
	 ...
	 * @throws IllegalArgumentException - if maxValue is neither positive nor INDEFINITE for non-interactive gauges
	 * @throws IllegalArgumentException - if initialValue is not one of CONTINUOUS_IDLE, INCREMENTAL_IDLE, CONTINUOUS_RUNNING, or INCREMENTAL_UPDATING for a non-interactive gauge with indefinite range
	 ...
	 * @throws IllegalStateException - if this Item is contained within an Alert
	 * @see setItemCommandListener in class Item
	 * @since  MIDP 2.0
	 */
	 ...
	 * @throws IllegalStateException - if this Item is contained within an Alert
	 * @see setDefaultCommand in class Item
	 * @since  MIDP 2.0
	 */
