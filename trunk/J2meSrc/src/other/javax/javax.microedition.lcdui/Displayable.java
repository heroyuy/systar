...
public abstract class Displayable
{
	...
	private final Simulation _simulator;
	public Display _display;
	
	protected Displayable() {
		this._simulator = Simulation.getCurrentSimulation();
	}
	...
	public boolean isShown()
	{
		...
		return (this._display.getCurrent() == this);
	}
	...
	public int getWidth()
	{
		return this._simulator.getCanvasWidth();
	}
	...
	{
		return this._simulator.getCanvasHeight();
	}
	...
	public void _callShowNotify() {
		if (this instanceof Canvas) {
			((Canvas) this).showNotify();
		}
	}
	
	public void _callHideNotify() {
		this.isShown = false;
		if (this instanceof Canvas) {
	...
	/**
	 * Paints this displayable on the simulator screen
	 */
	public void _simulatePaint() {
		this._simulator.requestRepaint(this);
		this.isShown = true;
	}
	 ...
	 * @param input
	 */
	public void _processInput(char input) {
		// ignore
	}
