    ...
    protected static Animation[] createAnimationList() {
        ...
        try {
            ...
            for (int i = 0; i < animationSum; i++) {
                ...
                animationList[i].image = Image.createImage("product/image/animation/" + animationList[i].imageName);
    ...
    protected static Enemy[] createEnemyList() {
        ...
        try {
            ...
            for (int i = 0; i < enemySum; i++) {
                ...
                enemyList[i].BattImg = Image.createImage("product/image/battler/" + dis.readUTF());
    ...
    protected static Item[] createItemList() {
        ...
        try {
            ...
            for (int i = 0; i < itemSum; i++) {
                ...
                itemList[i].icon = Image.createImage("product/image/icon/item/" + dis.readUTF());
    ...
    protected static Equip[] createEquipList() {
        ...
        try {
            ...
            for (int i = 0; i < equipSum; i++) {
                ...
                equipList[i].icon = Image.createImage("product/image/icon/equip/" + dis.readUTF());
