 ...
 */
public class MainFrame extends javax.swing.JFrame implements MapChangeListener, LayerChangeListener {
...
//        undoSupport.addUndoableEditListener(undoHandler);
    ...
    private void initComponents() {
        ...
        stateBarPanelLayout.setVerticalGroup(
            stateBarPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(scrollLabel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 31, Short.MAX_VALUE)
        );
        ...
        previewTabbedPane.setName("previewTabbedPane"); // NOI18N

        previewScrollPane.setName("previewScrollPane"); // NOI18N

        jLabel1.setText("待优化");
        jLabel1.setName("jLabel1"); // NOI18N
        previewScrollPane.setViewportView(jLabel1);

        previewTabbedPane.addTab("预览", previewScrollPane);

        jScrollPane2.setViewportView(previewTabbedPane);
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(mainSplitPane, javax.swing.GroupLayout.DEFAULT_SIZE, 511, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void openProject() {
        ...
        try {
            if (file != null) {
                Project.getInstance().setPath(file.getParent());
                if (ProjectManager.get()) {
                    this.setTitle(SoftInformation.chineseName + " - " + Project.getInstance().getName());
    ...
    private void addTilesetMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addTilesetMenuItemActionPerformed
        // TODO add your handling code here:
        if (Project.getInstance().getName().equals("")) {
            JOptionPane.showMessageDialog(this,
                "请先新建项目！");
            return;
        }
...
//            ((DefaultMutableTreeNode) data.getMainFrame().mapTree.getModel().getRoot()).add(newNode);
            ...
            if ((id == JOptionPane.OK_OPTION) && (mapTree.getSelectNode().getUserObject() instanceof Map)) {
                ...
                delAllChildrenMap(mapTree.getSelectNode());
                data.mapSetBase.removeMap((Map) mapTree.getSelectNode().getUserObject());
                ...
                layerTable.updateUI();
                System.out.println("size:" + data.mapSetBase.size());
            }

        }
    }

    private void delAllChildrenMap(DefaultMutableTreeNode tn) {
        ...
        for (int i = 0, n = tn.getChildCount(); i < n; i++) {
            ...
            if (dmt.getChildCount() > 0) {
                delAllChildrenMap(dmt);
//                System.out.println("del");
            }
            data.mapSetBase.removeMap((Map) (dmt).getUserObject());
        }
    }
    ...
    private void removeLayer() {
        ...
        if (data.getCurrentLayer() instanceof TileLayer) {
            if (data.getCurrentMap().getTotalLayers() > 3) {
                Layer layer = data.getCurrentLayer();
    ...
    public static void main(String args[]) {
        if (args.length > 0) {
            for (int i = 0, n = args.length; i < n; i++) {
                System.out.println(args[i]);//启动参数，暂不处理
            }
        }
