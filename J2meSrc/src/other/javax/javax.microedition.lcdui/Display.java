...
public class Display extends Object
{
	...
	private static Map displaysByMidlet = new HashMap();

	private Item currentItem;
	
	protected Display( MIDlet midlet, Simulation deviceSimulator ) {
		this.midlet = midlet;
		this.simulator = deviceSimulator;
	}
	 ...
	 * <code>MIDlet</code>.
	 * 
	 * @param midlet MIDlet of the application
	 * @return the display object that application can use for its user interface
	 * @throws NullPointerException if midlet is null
	 */
	public static Display getDisplay( MIDlet midlet)
	{
		Display display = (Display) displaysByMidlet.get( midlet );
		if (display == null) {
			display = new Display( midlet, Simulation.getSimulation( midlet ) );
			displaysByMidlet.put( midlet, display );
		}
		return display;
	}
	
	public static void  _removeSimulation( Simulation simulation ) {
		MIDlet midlet = simulation.getMIDlet();
		if (midlet != null) {
			displaysByMidlet.remove( midlet );
		}
	}
	...
	{
		return this.simulator.getNumberOfColors();
	}
	...
	{
		return this.simulator.getNumberOfAlphaLevels();
	}
