...
public class Graphics extends Object
{
	 ...
	 * 
	 * @param g the AWT graphics that actually renders all operations.
	 * @param simulation the device to which the graphics belongs to
	 */
	public Graphics( java.awt.Graphics2D g, Simulation simulation ) {
		if (g == null) {
			throw new IllegalArgumentException("The base AWT graphics must not be null");
		}
		this.g = g;
	...
	{
		//System.out.println("Graphics.translate: " + x + ", " + y);
		this.translateX += x;
		this.translateY += y;
	}
	...
	public void setColor(int red, int green, int blue)
	{
		...
		this.color = awtColor.getRGB(); // (red << 16) | (green << 8) | blue;  
	}
	...
	public void setColor(int rgb)
	{
		...
		this.g.setColor( awtColor );
		this.color = rgb;
		this.redComponent = awtColor.getRed();
		this.greenComponent = awtColor.getGreen();
		this.blueComponent = awtColor.getBlue();
	}
	...
	public void clipRect(int x, int y, int width, int height)
	{
		...
		Rectangle rect = this.g.getClipBounds();
		this.clipX = rect.x;
		this.clipY = rect.y;
	...
	public void drawLine(int x1, int y1, int x2, int y2)
	{
		...
		x2 += this.translateX;
		y2 += this.translateY;
		//TODO support dotted strokestyle 
	...
	{
		//System.out.println("drawString (" + str + ", x=" + x + ", y=" + y  + ", translateX=" + this.translateX + ", translateY=" + this.translateY + " )");
		...
		switch (horizontalAnchor) {
			case LEFT: 
				break;
			case HCENTER:
				//System.out.print("HCenter: x=" + x );
				x -= this.font.stringWidth(str) / 2;
				//System.out.println(" - and now=" + x);
				break;
			case RIGHT:
				x -= this.font.stringWidth(str);
				break;
			default: 
				throw new IllegalArgumentException("Invalid horizontal alignment: " + anchor );
		}
		int verticalAnchor = anchor & (TOP | BASELINE | BOTTOM );
		switch (verticalAnchor) {
			...
			case BOTTOM:
				...
				break;
			default: 
				throw new IllegalArgumentException("Invalid vertical alignment: " + anchor );
		}
	...
	public void drawImage( Image img, int x, int y, int anchor)
	{
		...
		int verticalAnchor = anchor & (TOP | VCENTER | BOTTOM );
		switch (verticalAnchor) {
			case TOP:
				break;
			case VCENTER:
		...
		this.g.drawImage( img.getBufferedImage(), x, y, null);
		
		if ( this.imageListener != null ) {
			this.imageListener.notifyImagePainted( img );
		}
	}
	 ...
	 * 
	 * @param rgb the desired color (in 0x00RRGGBB format, the high-order byte is ignored)
	 * @return the corresponding color that will be displayed on the device's screen (in 0x00RRGGBB format)
	 * @since  MIDP 2.0
	 */
	public int getDisplayColor(int rgb )
	{
		return rgb;
	}

	/**
	 * Resets the translation and clipping of this graphics.
	 */
	public void reset() {
		this.translateX = 0;
		this.translateY = 0;
		setClip( 0, 0, this.simulation.getCanvasWidth(), this.simulation.getCanvasHeight() );
	}
