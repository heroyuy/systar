...
public class EquipTableModel extends AbstractTableModel {
    ...
    private static final String EQUIP_COLUMN_NAME[] = {
        "ID", "名称"
    };
    private static final Class EQUIP_COLUMN_CLASS[] = {
        Integer.class, String.class
    };

    @Override
    public String getColumnName(int c) {
        return EQUIP_COLUMN_NAME[c];
    }

    @Override
    public Class<?> getColumnClass(int c) {
        return EQUIP_COLUMN_CLASS[c];
    }

    @Override
    public int getColumnCount() {
        return EQUIP_COLUMN_NAME.length;
    }
