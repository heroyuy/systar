...
public class SwitchDialog extends javax.swing.JDialog {
     ...
     * @param modal 
     */
    public SwitchDialog(ScriptDialog parent, boolean modal) {
        super(parent, modal);
        sd = parent;
        initComponents();
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        ...
        if (onRadioButton.isSelected()) {
            sd.insertScriptData(sd.npcPane.eventTable.getSelectedRow(), "setSwitch(" + switchComboBox.getSelectedIndex() + ",true);");
        } else {
            sd.insertScriptData(sd.npcPane.eventTable.getSelectedRow(), "setSwitch(" + switchComboBox.getSelectedIndex() + ",false);");
        }
        this.dispose();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                SwitchDialog dialog = new SwitchDialog(null, true);
