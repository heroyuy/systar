...
public class PreferenceDialog extends javax.swing.JDialog {
    ...
    public PreferenceDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        rightEraserCheckBox.setSelected(Config.getIsRightEraser());
    ...
    private void initComponents() {
        ...
        rightEraserCheckBox.setText("开启右键橡皮功能 (勾选后绘图时，右键点击也视为擦除)");
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        ...
        Config.saveIsRightEraser(rightEraserCheckBox.isSelected());
        if (uiTable.getSelectedRow() != -1) {
            Config.setSkin("org.pushingpixels.substance.api.skin.Substance" + uiTable.getModel().
