...
public class PreviewMapDialog extends javax.swing.JDialog {
    ...
    private void initialize() {
        ...
        previewScrollPane.setViewportView(SoftProxy.getInstance().getCurrentMap().getPreviewRender());
        SoftProxy.getInstance().getCurrentMap().getPreviewRender().repaint();
    }
    ...
    private void initComponents() {
        ...
        showCollideCheckBox.setSelected(SoftProxy.getInstance().getCurrentMap().getPreviewRender().isShowCollide());
        ...
        showSpriteCheckBox.setSelected(SoftProxy.getInstance().getCurrentMap().getPreviewRender().isShowSprite());
        ...
        showScreenCheckBox.setSelected(SoftProxy.getInstance().getCurrentMap().getPreviewRender().isShowScreen());
    ...
    private void showCollideCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showCollideCheckBoxActionPerformed
        // TODO add your handling code here:
        SoftProxy.getInstance().getCurrentMap().getPreviewRender().setShowCollide(showCollideCheckBox.isSelected());
        SoftProxy.getInstance().getCurrentMap().getPreviewRender().repaint();
    ...
    private void showSpriteCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showSpriteCheckBoxActionPerformed
        // TODO add your handling code here:
        SoftProxy.getInstance().getCurrentMap().getPreviewRender().setShowSprite(showSpriteCheckBox.isSelected());
        SoftProxy.getInstance().getCurrentMap().getPreviewRender().repaint();
    ...
    private void savePreviewButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_savePreviewButtonActionPerformed
        ...
        File file = new File("snapshot"
            + File.separator + "地图名称" + SoftProxy.getInstance().getCurrentMap().getName()
            + "像素大小" + SoftProxy.getInstance().getCurrentMap().getTileWidth() * SoftProxy.getInstance().getCurrentMap().getWidth()
            + "x" + SoftProxy.getInstance().getCurrentMap().getTileHeight() * SoftProxy.getInstance().getCurrentMap().getHeight() + ".png");
        try {
            ImageIO.write(SoftProxy.getInstance().getCurrentMap().getPreviewRender().getBufferedImage(), "png", file);
    ...
    private void setScreenButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_setScreenButtonActionPerformed
        ...
        SoftProxy.getInstance().getCurrentMap().getPreviewRender().setBound(Integer.parseInt(ScreenWTextField.getText()), Integer.parseInt(ScreenHTextField.getText()));
    ...
    private void showScreenCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showScreenCheckBoxActionPerformed
        // TODO add your handling code here:
        SoftProxy.getInstance().getCurrentMap().getPreviewRender().setShowScreen(showScreenCheckBox.isSelected());
        SoftProxy.getInstance().getCurrentMap().getPreviewRender().repaint();
