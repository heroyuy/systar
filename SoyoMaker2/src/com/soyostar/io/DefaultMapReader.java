...
//            System.out.println("图集文件：" + Project.getInstance().getPath() + path);
//            is.importTileBitmap(Project.getInstance().getPath() + path,
...
//                            script.setType(dis.readByte());
//                            if (script.getType() == -1) {
//                                continue;
//                            }
//                            script.setRow(dis.readInt());
//                            script.setCol(dis.readInt());
//                            String path = dis.readUTF();
//                            System.out.print("精灵图片: " + path);
//                            script.setImgPath(path);
//                            script.setFace(dis.readByte());
//                            System.out.print(" 精灵面向: " + script.getFace());
//                            script.setMove(dis.readByte());
//                            System.out.print(" 移动规则: " + script.getMove());
//                            script.setSpeed(dis.readByte());
//                            System.out.println(" 移动速度: " + script.getSpeed());
//                            int codeNums = dis.readInt();
//                            for (int ij = 0; ij < codeNums; ij++) {
//                                script.addCode(dis.readUTF());
//                            }
//                            ((SpriteLayer) layer).setNpcAt(k, j, script);
//                        }
//                    }
//                    break;
...
//                                continue;
//                            }
//                            tile.setTileSet(map.getTileSets().get(tilesetid));
//                            tile.setImage(dis.readInt());
//                            tile.setIndex(tile.getImageId());
