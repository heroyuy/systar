...
//                    System.out.println("npc");
                    ...
                    g2d.drawRect(gx + 1, gy - tsize.height + 1, tsize.width - 3, tsize.height - 3);
                    g2d.setComposite(AlphaComposite.getInstance(
                        AlphaComposite.SRC_ATOP, 0.25f));
                    g2d.fillRect(gx + 1, gy - tsize.height + 1, tsize.width - 3, tsize.height - 3);
                    ...
                    if (layer.getNpcAt(x, y).getNpcState(0).
                        ...
                        switch (layer.getNpcAt(x, y).getNpcState(0).getFace()) {
                            case NpcState.DOWN:
                                g2d.drawImage(layer.getNpcAt(x, y).getNpcState(0).getImg(), gx + 1, gy - tsize.height + 1, gx + tsize.width - 1, gy - 1,
                                    0, 0, layer.getNpcAt(x, y).getNpcState(0).getImg().getWidth(null) / 4, layer.getNpcAt(x, y).getNpcState(0).getImg().getHeight(null) / 4, null);
                                break;
                            case NpcState.LEFT:
                                g2d.drawImage(layer.getNpcAt(x, y).getNpcState(0).getImg(), gx + 1, gy - tsize.height + 1, gx + tsize.width - 1, gy - 1,
