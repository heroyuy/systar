...
public class ChangeImageARGBDialog extends javax.swing.JDialog {
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        ...
        sd.insertScriptData(sd.npcPane.eventTable.getSelectedRow(),
                "globalData.proxy:toneImage(" + imageComboBox.getSelectedItem() + "," + alphaSlider.getValue() + "," + redSlider.getValue() + "," + greenSlider.getValue() + "," + blueSlider.getValue() + "," + frameTextField.getText() + ");");
        dispose();
