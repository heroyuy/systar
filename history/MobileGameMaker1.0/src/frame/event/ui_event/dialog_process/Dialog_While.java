...
public class Dialog_While extends Event_Dialog {
    ...
    public Dialog_While(Dialog_Main parent) {
        super(parent);
        p = parent;
        initialize();
    }
    ...
    public boolean confirm() {
        ...
        switch (type) {
            case 0:
                sc = "WHILE $SWITCH[" + getJComboBox_switch().getSelectedIndex() + "]";
                break;
            case 1:
                sc = "WHILE $VAR[" + getJComboBox_var().getSelectedIndex() + "]" + getJTextField_condition().getText();
                break;
        }
        Dialog_Main.insertEventTM(Dialog_Main.getEventDialog().curRow, "ENDWHILE");
