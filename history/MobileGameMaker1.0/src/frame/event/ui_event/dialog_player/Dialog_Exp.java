...
public class Dialog_Exp extends Event_Dialog {
    ...
    public Dialog_Exp(Dialog_Main parent) {
        super(parent);
        initialize();
        p = parent;
    }
    ...
    public boolean confirm() {
        ...
        if (Optype == 0) {
            if (type == 0) {
                sc = "$EXP" + "+=" + getJTextField_const().getText();
            } else {
                sc = "$EXP" + "-=" + getJTextField_const().getText();
            }
        } else {
            if (type == 0) {
                sc = "$EXP" + "+=$VAR[" + getJComboBox_var().getSelectedIndex() + "]";
            } else {
                sc = "$EXP" + "-=$VAR[" + getJComboBox_var().getSelectedIndex() + "]";
            }
        }
