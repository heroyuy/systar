...
public class Dialog_Level extends Event_Dialog {
    ...
    public Dialog_Level(Dialog_Main parent) {
        super(parent);
        initialize();
        p = parent;
    }
    ...
    public boolean confirm() {
        ...
        if (Optype == 0) {
            if (type == 0) {
                sc = "$LEVEL" + "+=" + getJTextField_const().getText();
            } else {
                sc = "$LEVEL" + "-=" + getJTextField_const().getText();
            }
        } else {
            if (type == 0) {
                sc = "$LEVEL" + "+=$VAR[" + getJComboBox_var().getSelectedIndex() + "]";
            } else {
                sc = "$LEVEL" + "-=$VAR[" + getJComboBox_var().getSelectedIndex() + "]";
            }
        }
