...
public class Dialog_EquipShop extends Event_Dialog implements MouseListener {

    private JPanel jContentPane = null;
    private JScrollPane jScrollPane = null;
    private JTable jTable_equip = null;
    ...
    public Dialog_EquipShop(Dialog_Main parent) {
        super(parent);
        p = parent;
        initialize();
    }
    ...
    public boolean confirm() {
        ...
        sc.append("EQUIPSHOP");
        for (int i = 0; i < jTable_equip.getRowCount(); i++) {
            sc.append(" ").append(jTable_equip.getValueAt(i, 0).toString());
        }
    ...
    public void mouseClicked(MouseEvent e) {
        // TODO 弹出菜单和切换物品
        if (jTable_equip.getSelectedRow() != -1) {
            curRow = jTable_equip.getSelectedRow();
        }
...
//        System.out.println("del");
        int num = jTable_equip.getSelectedRow();
...
//                    insertRow();
    ...
    private JScrollPane getJScrollPane() {
        if (jScrollPane == null) {
            ...
            jScrollPane.setViewportView(getjTable_equip());
        }
        return jScrollPane;
    }
    ...
    /**
     * This method initializes jTable_equip
     *
     * @return javax.swing.JTable
     */
    private JTable getjTable_equip() {
        if (jTable_equip == null) {
            ...
            jTable_equip.setModel(dtm);
            jTable_equip.addMouseListener(this);
            String[] s = {"", "", ""};
            dtm.addRow(s);
        }
        return jTable_equip;
    ...
    private JComboBox getJComboBox_item() {
        if (jComboBox_item == null) {
            ...
            int m = Project.getEquipList().size();
            for (int i = 0; i < m; i++) {
                jComboBox_item.addItem(Project.getEquipList().equipAt(i).getName());
            }
        }
    ...
    private JButton getJButton_confirm() {
        if (jButton_confirm == null) {
            ...
            jButton_confirm.addActionListener(new java.awt.event.ActionListener() {
                ...
                @Override
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    String[] s = {"" + Project.getEquipList().equipAt(jComboBox_item.getSelectedIndex()).getIndex(), jComboBox_item.getSelectedItem().toString(), "" + Project.getEquipList().equipAt(jComboBox_item.getSelectedIndex()).getPrice()};
