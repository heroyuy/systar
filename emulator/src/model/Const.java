...
public final class Const {
    ...
    public static final class Font {
        ...
        public static final EmulatorFont FONTSMALL_PLAIN = EmulatorFont.getFont(EmulatorFont.FACE_SYSTEM, EmulatorFont.STYLE_PLAIN, EmulatorFont.SIZE_SMALL);
        public static final EmulatorFont FONTMEDIUM_PLAIN = EmulatorFont.getFont(EmulatorFont.FACE_SYSTEM, EmulatorFont.STYLE_PLAIN, EmulatorFont.SIZE_MEDIUM);
        public static final EmulatorFont FONTLARGE_PLAIN = EmulatorFont.getFont(EmulatorFont.FACE_SYSTEM, EmulatorFont.STYLE_PLAIN, EmulatorFont.SIZE_LARGE);
        public static final EmulatorFont FONTSMALL_BOLD = EmulatorFont.getFont(EmulatorFont.FACE_SYSTEM, EmulatorFont.STYLE_BOLD, EmulatorFont.SIZE_SMALL);
        public static final EmulatorFont FONTMEDIUM_BOLD = EmulatorFont.getFont(EmulatorFont.FACE_SYSTEM, EmulatorFont.STYLE_BOLD, EmulatorFont.SIZE_MEDIUM);
        public static final EmulatorFont FONTLARGE_BOLD = EmulatorFont.getFont(EmulatorFont.FACE_SYSTEM, EmulatorFont.STYLE_BOLD, EmulatorFont.SIZE_LARGE);
    }
