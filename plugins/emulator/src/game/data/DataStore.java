...
public class DataStore {
	...
	public Player getPlayer() {
		...
		player.headImage = new Image("res" + playerData.battlerImage);
		player.setCharImg("res" + playerData.characterImage);
		player.gotoMap(playerData.mapIndex, playerData.row, playerData.col,
				playerData.face);
		return player;
	}
	...
	public Actor getActor() {
		...
		actor.battlerImage = new Image("res" + playerData.battlerImage);
		...
		actor.expList = Arrays.copyOf(playerData.expList,
				playerData.expList.length);
		// 以下为初始化
		actor.exp = 0;
