    ...
    protected static Animation[] createAnimationList() {
        ...
        try {
            ...
            for (int i = 0; i < animationSum; i++) {
                ...
                animationList[i].image = EmulatorImage.createImage("product/image/animation/" + animationList[i].imageName);
    ...
    protected static Enemy[] createEnemyList() {
        ...
        try {
            ...
            for (int i = 0; i < enemySum; i++) {
                ...
                enemyList[i].BattImg = EmulatorImage.createImage("product/image/battler/" + dis.readUTF());
    ...
    protected static Item[] createItemList() {
        ...
        try {
            ...
            for (int i = 0; i < itemSum; i++) {
                ...
                itemList[i].icon = EmulatorImage.createImage("product/image/icon/item/" + dis.readUTF());
    ...
    protected static Equip[] createEquipList() {
        ...
        try {
            ...
            for (int i = 0; i < equipSum; i++) {
                ...
                equipList[i].icon = EmulatorImage.createImage("product/image/icon/equip/" + dis.readUTF());
    ...
    protected static Skill[] createSkillList() {
        ...
        try {
            ...
            for (int i = 0; i < skillSum; i++) {
                ...
                skillList[i].icon = EmulatorImage.createImage("product/image/icon/skill/" + dis.readUTF());
...
//                    }
            ...
            map.setImage(EmulatorImage.createImage("product/image/tileset/" + imageName));
            dis.close();
    ...
    static Player createPlayer() {
        ...
        try {
            ...
            player.headImg = EmulatorImage.createImage("product/image/battler/" + dis.readUTF());
            player.setCharImg(EmulatorImage.createImage("product/image/character/" + dis.readUTF()));
