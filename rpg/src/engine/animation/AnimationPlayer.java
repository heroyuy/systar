...
public class AnimationPlayer {
     ...
     * @param g 画笔
     */
    public void playNoClear(Graphics g) {
...
//            frame = ani.frames[ani.curIndex];
            ...
            if (ani.getCurFrame() != null) {
                g.drawRegion(ani.image, (ani.getCurFrame().num - 1) % picw * ani.frameWidth,
                    (ani.getCurFrame().num - 1) / picw * ani.frameHeight,
                    ani.frameWidth, ani.frameHeight, 0, ani.x + ani.getCurFrame().offsetX, ani.y + ani.getCurFrame().offsetY, Graphics.HCENTER | Graphics.VCENTER);
            }
//            img = frame.image;
