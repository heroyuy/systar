...
//        PreviewRenderFactory.createPreviewRender(map);
        ...
        if (data.getMainFrame().mapTree.getSelectNode() == null) {
            ...
            Object o = data.getMainFrame().mapTree.getSelectNode().getUserObject();
            if (o instanceof Map) {
                map.setParentMap((Map) o);
            }
        ...
        data.getMainFrame().mapScrollPane.setViewportView(map.getMapRender());
//        data.getMainFrame().previewScrollPane.setViewportView(map.getPreviewRender());
        dispose();
