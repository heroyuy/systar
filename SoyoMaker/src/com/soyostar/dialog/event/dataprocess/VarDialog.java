...
public class VarDialog extends javax.swing.JDialog {
     ...
     * @param modal  
     */
    public VarDialog(ScriptDialog parent, boolean modal) {
        super(parent, modal);
        sd = parent;
        initComponents();
    ...
    private void initComponents() {
        ...
        multRadioButton = new javax.swing.JRadioButton();
        divRadioButton = new javax.swing.JRadioButton();
        modRadioButton = new javax.swing.JRadioButton();
        ...
        var2ComboBox = new javax.swing.JComboBox();
        cancleButton = new javax.swing.JButton();
        okButton = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(VarDialog.class);
        ...
        equalRadioButton.setText("代入");
        equalRadioButton.setName("equalRadioButton"); // NOI18N

        buttonGroup1.add(addRadioButton);
        addRadioButton.setText("加法");
        addRadioButton.setName("addRadioButton"); // NOI18N

        buttonGroup1.add(removeRadioButton);
        removeRadioButton.setText("减法");
        removeRadioButton.setName("removeRadioButton"); // NOI18N

        buttonGroup1.add(multRadioButton);
        multRadioButton.setText("乘法");
        multRadioButton.setName("multRadioButton"); // NOI18N

        buttonGroup1.add(divRadioButton);
        divRadioButton.setText("除法");
        divRadioButton.setName("divRadioButton"); // NOI18N

        buttonGroup1.add(modRadioButton);
        modRadioButton.setText("取模");
        modRadioButton.setName("modRadioButton"); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(multRadioButton)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(divRadioButton)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 55, Short.MAX_VALUE)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(removeRadioButton, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(modRadioButton, javax.swing.GroupLayout.Alignment.TRAILING))
                .addContainerGap())
        );
        ...
        var2ComboBox.setEnabled(false);
        var2ComboBox.setName("var2ComboBox"); // NOI18N
        for(int i =0;i<100;i++){
            var2ComboBox.addItem(i);
        }
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(constTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 183, Short.MAX_VALUE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(varRadioButton)
                        .addGap(18, 18, 18)
                        .addComponent(var2ComboBox, 0, 183, Short.MAX_VALUE)))
                .addContainerGap())
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(varRadioButton)
                    .addComponent(var2ComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(varComboBox, 0, 236, Short.MAX_VALUE))
        ...
        if (equalRadioButton.isSelected()) {
            if (constRadioButton.isSelected()) {
                sd.insertScriptData(sd.npcPane.eventTable.getSelectedRow(),
                    "setVar(" + varComboBox.getSelectedIndex() + "," + constTextField.getText() + ");");
            } else {
                sd.insertScriptData(sd.npcPane.eventTable.getSelectedRow(),
                    "setVar(" + varComboBox.getSelectedIndex() + "," + "getVar(" + var2ComboBox.getSelectedIndex() + ")" + ");");
            }
        }
        if (addRadioButton.isSelected()) {
            if (constRadioButton.isSelected()) {
                sd.insertScriptData(sd.npcPane.eventTable.getSelectedRow(),
                    "setVar(" + varComboBox.getSelectedIndex() + ",getVar(" + varComboBox.getSelectedIndex() + ")+" + constTextField.getText() + ");");
            } else {
                sd.insertScriptData(sd.npcPane.eventTable.getSelectedRow(),
                    "setVar(" + varComboBox.getSelectedIndex() + ",getVar(" + varComboBox.getSelectedIndex() + ")+" + "getVar(" + var2ComboBox.getSelectedIndex() + ")" + ");");
            }
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                VarDialog dialog = new VarDialog(null, true);
    ...
    private javax.swing.JRadioButton divRadioButton;
    private javax.swing.JRadioButton equalRadioButton;
    private javax.swing.JLabel jLabel1;
    private javax.swing.JPanel jPanel1;
    private javax.swing.JPanel jPanel2;
    private javax.swing.JRadioButton modRadioButton;
    private javax.swing.JRadioButton multRadioButton;
    private javax.swing.JButton okButton;
    private javax.swing.JRadioButton removeRadioButton;
    private javax.swing.JComboBox var2ComboBox;
