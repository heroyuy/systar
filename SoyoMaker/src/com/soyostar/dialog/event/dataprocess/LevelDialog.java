...
public class LevelDialog extends javax.swing.JDialog {
     ...
     * @param modal 
     */
    public LevelDialog(ScriptDialog parent, boolean modal) {
        super(parent, modal);
        sd = parent;
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(LevelDialog.class);
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        ...
        if (addRadioButton.isSelected()) {
            if (constRadioButton.isSelected()) {
                sd.insertScriptData(sd.npcPane.eventTable.getSelectedRow(), "setLev(" + "getLev()+" + constTextField.getText() + ");");
            } else {
                sd.insertScriptData(sd.npcPane.eventTable.getSelectedRow(), "setLev(" + "getLev()+" + "getVar(" + varComboBox.getSelectedIndex() + ")" + ");");
            }
        } else {
            if (constRadioButton.isSelected()) {
                sd.insertScriptData(sd.npcPane.eventTable.getSelectedRow(), "setLev(" + "getLev()-" + constTextField.getText() + ");");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                LevelDialog dialog = new LevelDialog(null, true);
