...
//        for (int y = 0; y < bounds.height; y++) {
//            for (int x = 0; x < bounds.width; x++) {
//                if (clone.tiles[y][x] != null) {
//                    if (clone.tiles[y][x].isIsCross()) {
//                        System.out.print(" 1");
//                    } else {
//                        System.out.print(" 0");
//                    }
...
//            System.out.println("t creatediff");
            Rectangle r = null;
...
//        System.out.println("t copyfrome");
    }
        ...
        if (bounds.contains(tx, ty) && isIsVisible()) {
            ...
            if (map != null && sync) {
                ...
                for (int i = 0; i < map.getTotalLayers(); i++) {
                    ...
                    if (layer instanceof CollideLayer) {
                        CollideLayer cd = (CollideLayer) layer;
                        cd.collides[ty][tx] = ti != null ? !ti.isIsCross() : false;
                    }
                }
            }
            fireLayerChanged();
