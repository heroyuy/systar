 ...
 * @version 1.0
 */
public class JInfiniteProgressPanel extends JComponent implements MouseListener {
     ...
     */
    public JInfiniteProgressPanel(String text, int barsCount) {
     ...
     *               shield (or veil).
     */
    public JInfiniteProgressPanel(String text, int barsCount, float shield) {
     ...
     *            decrease CPU usage.
     */
    public JInfiniteProgressPanel(String text, int barsCount, float shield, float fps) {
     ...
     */
    public JInfiniteProgressPanel(String text, int barsCount, float shield, float fps, int rampDelay) {
        this.text = text;
    ...
    private Area[] buildTicker() {
        Area[] tic = new Area[barsCount];
        Point2D.Double center = new Point2D.Double(this.getParent().getWidth() / 2, this.getParent().getHeight() / 2);
    ...
    private class Animator implements Runnable {
        ...
        public void run() {
            Point2D.Double center = new Point2D.Double(JInfiniteProgressPanel.this.getParent().getWidth() / 2, JInfiniteProgressPanel.this.getParent().getHeight() / 2);
            ...
            if (!rampUp) {
                ...
                setVisible(false);
                removeMouseListener(JInfiniteProgressPanel.this);
            }
        }
    }
