 ...
 */
public class SkillDialog extends AbCommandDialog {
     ...
     * @param typeId 
     */
    public SkillDialog(ScriptDialog parent, boolean modal, int typeId) {
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        ...
        mCommand.addParameter("" + ((Skill) skillComboBox.getSelectedItem()).getIndex());
