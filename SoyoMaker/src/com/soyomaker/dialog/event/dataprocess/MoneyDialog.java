 ...
 */
public class MoneyDialog extends AbCommandDialog {

    /** Creates new form MoneyDialog
     * @param parent
     * @param modal
     * @param typeId
     */
    public MoneyDialog(ScriptDialog parent, boolean modal, int typeId) {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(MoneyDialog.class);
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(constTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 154, Short.MAX_VALUE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(varRadioButton)
                        .addGap(18, 18, 18)
                        .addComponent(varComboBox, 0, 154, Short.MAX_VALUE)))
                .addContainerGap())
        );
...
//                sd.insertScriptData(sd.npcPane.eventTable.getSelectedRow(), "globalData.proxy:operateMoney(" + "1,0," + constTextField.getText() + ")");
            } else {
                mCommand.addParameter("1");
                mCommand.addParameter("1");
                mCommand.addParameter("Interpreter:doCommand(" + Command.GET_VAR_STATE + "," + varComboBox.getSelectedIndex() + ")");
//                sd.insertScriptData(sd.npcPane.eventTable.getSelectedRow(), "globalData.proxy:operateMoney(" + "1,1," + "globalData.proxy:getVariable(" + varComboBox.getSelectedIndex() + ")" + ")");
            }
        } else {
            if (constRadioButton.isSelected()) {
                ...
                mCommand.addParameter("0");
                mCommand.addParameter(constTextField.getText());
//                sd.insertScriptData(sd.npcPane.eventTable.getSelectedRow(), "globalData.proxy:operateMoney(" + "2,0," + constTextField.getText() + ");");
            } else {
                mCommand.addParameter("2");
                mCommand.addParameter("1");
                mCommand.addParameter("Interpreter:doCommand(" + Command.GET_VAR_STATE + "," + varComboBox.getSelectedIndex() + ")");
//                sd.insertScriptData(sd.npcPane.eventTable.getSelectedRow(), "globalData.proxy:operateMoney(" + "2,1," + "globalData.proxy:getVariable(" + varComboBox.getSelectedIndex() + ")" + ")");
            }
        }
