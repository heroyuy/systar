 ...
 */
public class ItemDialog extends AbCommandDialog {
     ...
     * @param typeId
     */
    public ItemDialog(ScriptDialog parent, boolean modal, int typeId) {
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        ...
        mCommand.addParameter("" + ((Item) itemComboBox.getSelectedItem()).getIndex());
...
//                sd.insertScriptData(sd.npcPane.eventTable.getSelectedRow(), "globalData.proxy:operateItem(" + itemComboBox.getSelectedIndex() + ",1,0," + constTextField.getText() + ")");
            } else {
                mCommand.addParameter("1");
                mCommand.addParameter("1");
                mCommand.addParameter("Interpreter:doCommand(" + Command.GET_VAR_STATE + "," + varComboBox.getSelectedIndex() + ")");
//                sd.insertScriptData(sd.npcPane.eventTable.getSelectedRow(), "globalData.proxy:operateItem(" + itemComboBox.getSelectedIndex() + ",1,1," + "globalData.proxy:getVariable(" + varComboBox.getSelectedIndex() + ")" + ")");
            }
        } else {
            if (constRadioButton.isSelected()) {
                ...
                mCommand.addParameter("0");
                mCommand.addParameter(constTextField.getText());
//                sd.insertScriptData(sd.npcPane.eventTable.getSelectedRow(), "globalData.proxy:operateItem(" + itemComboBox.getSelectedIndex() + ",2,0," + constTextField.getText() + ");");
            } else {
                mCommand.addParameter("2");
                mCommand.addParameter("1");
                mCommand.addParameter("Interpreter:doCommand(" + Command.GET_VAR_STATE + "," + varComboBox.getSelectedIndex() + ")");
//                sd.insertScriptData(sd.npcPane.eventTable.getSelectedRow(), "globalData.proxy:operateItem(" + itemComboBox.getSelectedIndex() + ",2,1," + "globalData.proxy:getVariable(" + varComboBox.getSelectedIndex() + ")" + ")");
            }
        }
