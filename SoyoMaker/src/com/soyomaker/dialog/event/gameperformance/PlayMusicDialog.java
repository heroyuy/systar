 ...
 */
public class PlayMusicDialog extends AbCommandDialog {
     ...
     * @param typeId
     */
    public PlayMusicDialog(ScriptDialog parent, boolean modal, int typeId) {
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        ...
        if (musicComboBox.getSelectedIndex() != -1) {
            ...
            mCommand.addParameter("" + loopCheckBox.isSelected());
            System.out.println(mCommand);
            this.dispose();
//            sd.insertScriptData(sd.npcPane.eventTable.getSelectedRow(),
//                    "globalData.proxy:playerMusic(" + "\"/audio/music/" + musicComboBox.getSelectedItem() + "\"" + "," + loopCheckBox.isSelected() + ")");
        }
