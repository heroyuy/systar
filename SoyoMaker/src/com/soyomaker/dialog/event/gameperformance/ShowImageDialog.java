 ...
 */
public class ShowImageDialog extends AbCommandDialog {
     ...
     * @param typeId
     */
    public ShowImageDialog(ScriptDialog parent, boolean modal, int typeId) {
...
//                        "globalData.proxy:showImage(" + "\"/image/picture/" + imageComboBox.getSelectedItem() + "\"" + "," + xTextField.getText() + "," + yTextField.getText() + "," + frameTextField.getText() + ")");
            } else {
                mCommand.addParameter(xTextField.getText());
                mCommand.addParameter(yTextField.getText());
                mCommand.addParameter("" + -1);
//                sd.insertScriptData(sd.npcPane.eventTable.getSelectedRow(),
//                        "globalData.proxy:showImage(" + "\"/image/picture/" + imageComboBox.getSelectedItem() + "\"" + "," + xTextField.getText() + "," + yTextField.getText() + ",-1)");
            }
