...
public class ConfigPanel extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        configBodyTextField.setText(config.term.vita);
        ...
        configMagicAtkTextField.setText(config.term.matk);
        configMagicDefTextField.setText(config.term.mdef);
        ...
        configMoneyTextField.setText(config.term.gold);
    ...
    public void save() {
        ...
        config.term.vita = configBodyTextField.getText();
        ...
        config.term.matk = configMagicAtkTextField.getText();
        config.term.mdef = configMagicDefTextField.getText();
    ...
    private void initComponents() {
        ...
        configPlayerTable.setRowHeight(20);
        ...
        initMapComboBox.setEnabled(false);
        ...
        initFaceComboBox.setEnabled(false);
        initFaceComboBox.setName("initFaceComboBox"); // NOI18N

        buttonGroup1.add(directRadioButton);
        directRadioButton.setSelected(true);
        directRadioButton.setText("直接指定");
        directRadioButton.setName("directRadioButton"); // NOI18N
        directRadioButton.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                directRadioButtonStateChanged(evt);
            }
        });

        buttonGroup1.add(varRadioButton);
        varRadioButton.setText("变量指定");
        ...
        markPositionButton.setText("指定位置");
        ...
        configAttributeTable.setRowHeight(20);
        ...
        jPanel10.setBorder(javax.swing.BorderFactory.createTitledBorder("音效图像"));
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                ...
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel10Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(equipSoundComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel10Layout.createSequentialGroup()
                        .addComponent(jLabel43)
                        .addGap(18, 18, 18)
                        .addComponent(warnSoundComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel10Layout.createSequentialGroup()
                        .addComponent(jLabel41)
                        .addGap(18, 18, 18)
                        .addComponent(okSoundComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel10Layout.createSequentialGroup()
                        .addComponent(jLabel42)
                        .addGap(18, 18, 18)
                        .addComponent(cancleSoundComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel10Layout.createSequentialGroup()
                        .addComponent(jLabel40)
                        .addGap(18, 18, 18)
                        .addComponent(selectSoundComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel10Layout.createSequentialGroup()
                        .addComponent(jLabel45)
                        .addGap(18, 18, 18)
                        .addComponent(shopSoundComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel10Layout.createSequentialGroup()
                        .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void varRadioButtonStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_varRadioButtonStateChanged
        // TODO add your handling code here:
        initMapComboBox.setEnabled(varRadioButton.isSelected());
        initRowTextField.setEnabled(varRadioButton.isSelected());
        initColTextField.setEnabled(varRadioButton.isSelected());
        initFaceComboBox.setEnabled(varRadioButton.isSelected());
    }//GEN-LAST:event_varRadioButtonStateChanged

    private void directRadioButtonStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_directRadioButtonStateChanged
        // TODO add your handling code here:
        markPositionButton.setEnabled(directRadioButton.isSelected());
    }//GEN-LAST:event_directRadioButtonStateChanged
    ...
    private void markPositionButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_markPositionButtonActionPerformed
        ...
        DirectSetInitPositionDialog sipd = new DirectSetInitPositionDialog(true);
