 ...
 */
public class ChangeSkinDialog extends AbCommandDialog {
     ...
     * @param typeId
     */
    public ChangeSkinDialog(ScriptDialog parent, boolean modal, int typeId) {
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        ...
        if (skinComboBox.getSelectedIndex() == -1) {
            mCommand.addParameter("nil");
        } else {
            mCommand.addParameter("\"/image/skin/" + skinComboBox.getSelectedItem() + "\"");
        }
        System.out.println(mCommand);
//        sd.insertScriptData(sd.npcPane.eventTable.getSelectedRow(), "changeSkin(" + "\"/image/skin/" + skinComboBox.getSelectedItem() + "\"" + ");");
        dispose();
