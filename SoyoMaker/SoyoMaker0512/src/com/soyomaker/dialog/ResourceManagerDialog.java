...
public class ResourceManagerDialog extends javax.swing.JDialog {
    ...
    private void removeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeButtonActionPerformed
        ...
        try {
            ...
            printer.e("删除文件失败！" + AppData.getInstance().getCurProject().getPath() + File.separator + dirList.get(dirNameList.getSelectedIndex()) + File.separator + fileNameList.getSelectedValue());
    ...
    private void importButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_importButtonActionPerformed
        ...
        if (ret == JFileChooser.APPROVE_OPTION) {
            try {
                ...
                printer.e("复制文件失败！" + ch.getSelectedFile().getPath());
