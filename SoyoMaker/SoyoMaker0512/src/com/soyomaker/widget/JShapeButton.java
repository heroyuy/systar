 ...
 */
public class JShapeButton extends JButton {
    ...
    protected void paintComponent(Graphics g) {
        ...
        switch (style) {
            ...
            case LEFT_ROUND_RECT: {
                ...
                g2d.setClip(clip);
                g2d.setPaint(p1);
                g2d.drawRoundRect(0, 0, (w - 1) + 20, h - 1, 30, 30);
                g2d.setPaint(p2);
                g2d.drawRoundRect(1, 1, (w - 3) + 20, h - 3, 28, 28);
                g2d.setPaint(p1);
            ...
            case RIGHT_ROUND_RECT: {
                ...
                g2d.setClip(clip);
                g2d.setPaint(p1);
                g2d.drawRoundRect(-20, 0, (w - 1) + 20, h - 1, 30, 30);
                g2d.setPaint(p2);
                g2d.drawRoundRect(-19, 1, (w - 3) + 20, h - 3, 28, 28);
                g2d.setPaint(p1);
