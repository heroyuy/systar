...
public class Preference {
    ...
    private static final Preferences prefs = Preferences.userRoot().node("soyomaker");
    private static final Preferences rightEraserPrefs = Preferences.userRoot().node("soyomaker.eraser");
    private static final Preferences autoTilePrefs = Preferences.userRoot().node("soyomaker.autotile");
    private static final Preferences skinPrefs = Preferences.userRoot().node("soyomaker.skin");
