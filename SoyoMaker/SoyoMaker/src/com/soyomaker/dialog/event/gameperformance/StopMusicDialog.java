 ...
 */
public class StopMusicDialog extends javax.swing.JDialog {

    /** Creates new form StopMusicDialog
     * @param parent
     * @param modal  
     */
    public StopMusicDialog(ScriptDialog parent, boolean modal) {
        super(parent, modal);
        sd = parent;
        initComponents();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                StopMusicDialog dialog = new StopMusicDialog(null, true);
