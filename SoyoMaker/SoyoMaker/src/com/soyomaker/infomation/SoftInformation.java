...
public class SoftInformation {
     ...
     * 
     */
    public static final int minorVersion = 07;//次版本号：次版本号有2位，偶数表示稳定版，奇数表示开发版，数据结构或者较大修改，增加此版本数
    /**
     *
     */
     ...
     * 
     */
    public static final int modifiedVersion = 20111225;//修改号：修改号8位，采用提交时的日期，当系统进行任何修改后，修改号都要随之改变
}
