...
//        System.out.println("enemy load");
        AppData.getInstance().getLogger().v("enemy load");
...
//            System.out.println("没有可加载的Enemy");
            AppData.getInstance().getLogger().e("没有可加载的Enemy");
        }
    }
...
//        System.out.println("enemy save");
        AppData.getInstance().getLogger().v("enemy save");
        boolean value = false;
        if (saveLua() && saveBin()) {
            value = true;
        }
